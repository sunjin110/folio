...
import { GetArticleByIdOutput, GetArticleSummariesOutput } from "./response/article";
...
export async function getArticleById(articleID: string): Promise<GetArticleByIdOutput | ErrorResponse> {
...
export async function createArticle(title: string, body: string): Promise<EmptyResponse | ErrorResponse> {
