...
import type {
  ...
  ArticlesPostRequest,
  ArticlesTagsGet200Response,
  ArticlesTagsPostRequest,
  ArticlesTagsTagIdPutRequest,
...
import {
    ...
    ArticlesTagsGet200ResponseFromJSON,
    ArticlesTagsGet200ResponseToJSON,
    ArticlesTagsPostRequestFromJSON,
    ArticlesTagsPostRequestToJSON,
    ArticlesTagsTagIdPutRequestFromJSON,
    ArticlesTagsTagIdPutRequestToJSON,
...
export interface ArticlesTagsGetRequest {
    searchText?: string;
    offset?: number;
    limit?: number;
}

export interface ArticlesTagsPostOperationRequest {
    articlesTagsPostRequest?: ArticlesTagsPostRequest;
}

export interface ArticlesTagsTagIdDeleteRequest {
    tagId: string;
}

export interface ArticlesTagsTagIdPutOperationRequest {
    tagId: string;
    articlesTagsTagIdPutRequest?: ArticlesTagsTagIdPutRequest;
}
...
export class GolioApi extends runtime.BaseAPI {
     ...
     * 記事タグ一覧取得
     */
    async articlesTagsGetRaw(requestParameters: ArticlesTagsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ArticlesTagsGet200Response>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ArticlesTagsGet200ResponseFromJSON(jsonValue));
    }
     ...
     * 記事タグ一覧取得
     */
    async articlesTagsGet(requestParameters: ArticlesTagsGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ArticlesTagsGet200Response> {
        const response = await this.articlesTagsGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 記事タグの作成
     */
    async articlesTagsPostRaw(requestParameters: ArticlesTagsPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InsertArticleTagResponse>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ArticlesTagsPostRequestToJSON(requestParameters['articlesTagsPostRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => InsertArticleTagResponseFromJSON(jsonValue));
    }
     ...
     * 記事タグの作成
     */
    async articlesTagsPost(requestParameters: ArticlesTagsPostOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InsertArticleTagResponse> {
        const response = await this.articlesTagsPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 記事タグの削除
     */
    async articlesTagsTagIdDeleteRaw(requestParameters: ArticlesTagsTagIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteArticleTagResponse>> {
        if (requestParameters['tagId'] == null) {
            throw new runtime.RequiredError(
                'tagId',
                'Required parameter "tagId" was null or undefined when calling articlesTagsTagIdDelete().'
            );
        }
        ...
        const response = await this.request({
            path: `/articles/tags/{tag_id}`.replace(`{${"tag_id"}}`, encodeURIComponent(String(requestParameters['tagId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => DeleteArticleTagResponseFromJSON(jsonValue));
    }
     ...
     * 記事タグの削除
     */
    async articlesTagsTagIdDelete(requestParameters: ArticlesTagsTagIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeleteArticleTagResponse> {
        const response = await this.articlesTagsTagIdDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 記事タグの更新
     */
    async articlesTagsTagIdPutRaw(requestParameters: ArticlesTagsTagIdPutOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateArticleTagResponse>> {
        if (requestParameters['tagId'] == null) {
            throw new runtime.RequiredError(
                'tagId',
                'Required parameter "tagId" was null or undefined when calling articlesTagsTagIdPut().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ArticlesTagsTagIdPutRequestToJSON(requestParameters['articlesTagsTagIdPutRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UpdateArticleTagResponseFromJSON(jsonValue));
    }
     ...
     * 記事タグの更新
     */
    async articlesTagsTagIdPut(requestParameters: ArticlesTagsTagIdPutOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateArticleTagResponse> {
        const response = await this.articlesTagsTagIdPutRaw(requestParameters, initOverrides);
        return await response.value();
    }
