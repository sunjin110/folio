...
import type { ArticlesGet200ResponseArticlesInner } from './ArticlesGet200ResponseArticlesInner';
import {
    ArticlesGet200ResponseArticlesInnerFromJSON,
    ArticlesGet200ResponseArticlesInnerFromJSONTyped,
    ArticlesGet200ResponseArticlesInnerToJSON,
} from './ArticlesGet200ResponseArticlesInner';
...
export interface ArticlesGet200Response {
    /**
     * 
     * @type {Array<ArticlesGet200ResponseArticlesInner>}
     * @memberof ArticlesGet200Response
     */
    articles: Array<ArticlesGet200ResponseArticlesInner>;
    /**
     * 
     * @type {number}
     * @memberof ArticlesGet200Response
...
export function ArticlesGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ArticlesGet200Response {
    ...
    return {
        ...
        'articles': ((json['articles'] as Array<any>).map(ArticlesGet200ResponseArticlesInnerFromJSON)),
        'total': json['total'],
    };
}
...
export function ArticlesGet200ResponseToJSON(value?: ArticlesGet200Response | null): any {
    ...
    return {
        ...
        'articles': ((value['articles'] as Array<any>).map(ArticlesGet200ResponseArticlesInnerToJSON)),
        'total': value['total'],
    };
}
