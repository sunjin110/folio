...
export function TranslationPostRequestFromJSON(json: any): TranslationPostRequest {
    return TranslationPostRequestFromJSONTyped(json, false);
}

export function TranslationPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TranslationPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TranslationPostRequestToJSON(value?: TranslationPostRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
