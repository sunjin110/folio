...
import { Book, Code2, HelpCircle, MessageCircleMore, Newspaper, Radius, Settings, SquareUser, Triangle } from "lucide-react";
            ...
            <nav className="grid gap-1 p-2">
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Button variant="ghost" size="icon" className={`rounded-lg ${sidebarPosition === 'messages' ? 'bg-muted': ''}`} aria-label="Message">
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        <Link to={"/articles"}>
                            <Button variant="ghost" size="icon" className={`rounded-lg ${sidebarPosition === 'articles' ? 'bg-muted': ''}`} aria-label="Articles">
