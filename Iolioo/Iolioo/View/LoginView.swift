...
struct LoginView: View {
    ...
    func handleGoogleSignInOnTap() {
        ...
        GIDSignIn.sharedInstance.signIn(withPresenting: rootViewController as UIViewController) {
            ...
            signInResult.user.refreshTokensIfNeeded { user, error in
                if error != nil {
                    print(
                        "fialed signInResult.user.refreshTokensIfNeeded. error: \(error.debugDescription)"
                    )
                    return
                }
