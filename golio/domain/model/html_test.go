	...
	Convey("TestHtmlExtracter_ExtractText", t, func() {
		...
		tests := []test{
			...
			},
			{
				...
				htmlContent: "<html><head></head><body><img src='https://image.com/fuga.jpg' /><img src='/static/hoge.jpg'></img></body></html>",
				want:        "https://image.com/fuga.jpg https://image.com/static/hoge.jpg",
			},
		}
