...
type GolioAPIRouter interface { 
	...
	EnglishDictionaryWordBookmarkDelete(http.ResponseWriter, *http.Request)
	EnglishDictionaryWordBookmarkPut(http.ResponseWriter, *http.Request)
	...
	TasksIdGet(http.ResponseWriter, *http.Request)
	TasksIdPut(http.ResponseWriter, *http.Request)
	TasksPost(http.ResponseWriter, *http.Request)
...
type GolioAPIServicer interface { 
	...
	EnglishDictionaryWordBookmarkDelete(context.Context, string, map[string]interface{}) (ImplResponse, error)
	EnglishDictionaryWordBookmarkPut(context.Context, string, map[string]interface{}) (ImplResponse, error)
	...
	TasksIdGet(context.Context, string, map[string]interface{}) (ImplResponse, error)
	TasksIdPut(context.Context, string, TasksPostRequest) (ImplResponse, error)
	TasksPost(context.Context, TasksPostRequest) (ImplResponse, error)
